<template>
  <div class="container mx-auto flex flex-col items-center bg-gray-100 p-4">
    <div class="container">
      ...
      <hr v-if="prices.length" class="w-full border-t border-gray-600 my-4" />
...
export default {
  ...
  methods: {
    cnangePrice() {
      this.prices = this.prices.map((p) => ({ ...p, price: p.price + 1 }));
    },
    handleDelete(prices) {
      this.prices = this.prices.filter((price) => price.name !== prices.name);
    },
  },
};
</script>
